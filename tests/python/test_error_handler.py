...
from core.error_handler import ErrorHandler, ErrorLevel, stderr_observer  # noqa: E402
...
class TestErrorHandler:
    ...
    def test_notify_calls_observers(self, mock_stderr):
        ...
        self.handler.notify(
            ErrorLevel.ERROR, "test_context", "TestError", "Test message"
        )

        observer1.assert_called_once_with(
            ErrorLevel.ERROR, "test_context", "TestError", "Test message", None
        )
    ...
    def test_formatted_message_structure(self, mock_stderr):
        ...
        self.handler.notify(
            ErrorLevel.WARNING, "my_context", "MyErrorType", "My error message"
        )
